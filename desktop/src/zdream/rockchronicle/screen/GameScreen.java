...
public class GameScreen implements Screen {
	...
	public GameScreen() {
		...
		this.game = RockChronicleDesktop.INSTANCE;
	...
	public void render(float delta) {
		...
		// all drops
		game.batch.begin();
		game.font.draw(game.batch, "Drops 你收集了: " + dropsGathered, 0, 432);
		game.batch.draw(megaman.getTextureEntry("normal").region, bucket.x, bucket.y, bucket.width, bucket.height);
