...
public class OutsideDestroyModule extends DestroyModule {
	...
	public void determine(LevelWorld world, int index, boolean hasNext) {
		...
		if (age > outsideTrialPeriod) {
			...
			// TODO 怎么没有一个好一点的方法
			boolean overlap = 0 < box.posX + box.posWidth
					&& world.currentRoom.width * Box.P_PER_BLOCK > box.posX
					&& 0 < box.posY + box.posHeight
					&& world.currentRoom.height * Box.P_PER_BLOCK > box.posY;
