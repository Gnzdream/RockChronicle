...
public class BaseJumpModule extends JumpModule implements IMovable {
	 ...
	 * 单位: p
	 */
	public int impulse; // param.impulse
	/**
	 * 单位: p / 步
	 */
	public int decay; // param.decay
	/**
	 * 单位: p / 步
	 */
	public int maxDropVelocity; // param.maxDropVelocity
	...
	public void init(FileHandle file, JsonValue value) {
		...
		this.impulse = (int) (oparam.getFloat("impulse") * LevelWorld.TIME_STEP
				* P_PER_BLOCK);
		this.decay = (int) (oparam.getFloat("decay") * LevelWorld.TIME_STEP 
				* LevelWorld.TIME_STEP * P_PER_BLOCK);
		this.maxDropVelocity = (int) (oparam.getFloat("maxDropVelocity")
				* LevelWorld.TIME_STEP * P_PER_BLOCK);
	...
	public void determine(LevelWorld world, int index, boolean hasNext) {
		...
		if (!onTheGround && gravityScale != 0) {
			...
			int maxDropVelocity = (int) (this.maxDropVelocity * gravityScale);
			if (box.gravityDown) {
