...
public class MegamanMotionModule extends TerrainMotionModule implements IMovable {
	...
	public static final int
		HORIZONTAL_VELOCITY_DELTA = 50 * Box.P_PER_BLOCK,
		HORIZONTAL_VELOCITY_MAX = (int) (5.4f * Box.P_PER_BLOCK),
		PARRY_VELOCITY = Box.P_PER_BLOCK;
	...
	public MegamanMotionModule(MegamanInLevel parent) {
		...
		this.phorizontalVelDelta =
				(int) (HORIZONTAL_VELOCITY_DELTA * LevelWorld.TIME_STEP * LevelWorld.TIME_STEP);
		this.phorizontalVelMax = (int) (HORIZONTAL_VELOCITY_MAX * LevelWorld.TIME_STEP);
		this.pparryVel = (int) (PARRY_VELOCITY * LevelWorld.TIME_STEP);
